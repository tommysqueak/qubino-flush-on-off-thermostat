 ...
 *
 *  https://github.com/tommysqueak/qubino-flush-on-off-thermostat
 *
...
{
	raiseThermostatEvents(cmd.operatingState)
}
...
def refresh() {
  ...
  delayBetween([
    ...
    zwave.sensorMultilevelV5.sensorMultilevelGet(sensorType: 1,scale: 0).format(), //temperature
    //zwave.thermostatModeV2.thermostatModeGet().format(), // mode - heating, off etc
